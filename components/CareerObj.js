    ...
    <section>
      {careerDatas.map((item, index) => (
        <div key={index}>
          ...
          <div className="text-lg font-semibold tracking-wider text-blue-800  dark:text-blue-100 bg-gray-100 dark:bg-gray-900 border border-gray-100 dark:border-blue-800 p-6 rounded-lg">
            <p>{item.careertext}</p>
          </div>
        </div>
      ))}
