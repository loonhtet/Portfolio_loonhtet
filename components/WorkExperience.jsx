  ...
  const experiences = [
    {
      ...
      company: "Softcomm",
      description:
        "Developed an employee management dashboard using Laravel. Assisted in web application development and testing to ensure functionality and usability. Performed system troubleshooting and provided technical user support.",
    ...
    },
    {
      ...
      company: "AYA Bank",
      description:
        "Collaborated on performance optimization. Integrated APIs and managed dynamic content for web applications.",
      currentlyWorking: false,
    },
    {
      ...
      description:
        "Assisted in web application development, focusing on responsive frontend design.",
    ...
    },
    {
      ...
      description:
        "Developed responsive websites and collaborated on UI/UX prototypes and backend APIs using NextJS. Integrated APIs into client websites, ensuring seamless functionality. Evaluated and selected frontend technologies to optimize performance and user experience.",
      currentlyWorking: true,
    },
  ];
          ...
          {experiences.map((exp, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-md font-semibold text-gray-400 italic">
                  {exp.company}
                </p>
                ...
                {exp.currentlyWorking && (
                  <div className="absolute -top-[50px] right-[-10px] flex items-center">
                    ...
                    <span className="ml-2 text-xs font-medium text-teal-300 italic">
                      Currently Working
                    </span>
                  </div>
                )}
